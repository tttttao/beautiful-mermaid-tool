...
<template>
  <div class="absolute bottom-6 right-6 z-20 flex flex-wrap items-center justify-end gap-3 max-w-[calc(100%-3rem)]">
    ...
    <button :class="buttonClass" :disabled="exportDisabled !== undefined ? exportDisabled : (disabled ? true : undefined)" type="button" title="Export PNG" aria-label="Export PNG" @click="emit('export')">
