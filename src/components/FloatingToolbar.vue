...
<template>
  <div class="absolute bottom-6 right-6 z-20 flex flex-wrap items-center justify-end gap-3 max-w-[calc(100%-3rem)]">
    ...
    <button :class="buttonClass" :disabled="disabled" type="button" aria-live="polite" :title="isSaved ? 'Chart saved' : 'Save Chart'" :aria-label="isSaved ? 'Chart saved' : 'Save Chart'" @click="handleSave">
